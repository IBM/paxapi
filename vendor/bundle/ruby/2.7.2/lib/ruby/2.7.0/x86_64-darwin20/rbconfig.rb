...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.7.0/x86_64-darwin20")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/charliele/.rbenv/versions/2.7.2")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/charliele/.rbenv/versions/2.7.2' '--with-openssl-dir=/Users/charliele/.rbenv/versions/2.7.2/openssl' '--enable-shared' '--with-readline-dir=/usr/local/opt/readline' 'CC=clang' 'LDFLAGS=-L/Users/charliele/.rbenv/versions/2.7.2/lib ' 'CPPFLAGS=-I/Users/charliele/.rbenv/versions/2.7.2/include '"
  ...
  CONFIG["arch"] = "x86_64-darwin20"
  CONFIG["sitearchincludedir"] = "$(includedir)/$(sitearch)"
  CONFIG["archincludedir"] = "$(includedir)/$(arch)"
  CONFIG["sitearchlibdir"] = "$(libdir)/$(sitearch)"
  CONFIG["archlibdir"] = "$(libdir)/$(arch)"
  CONFIG["libdirname"] = "libdir"
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/charliele/.rbenv/versions/2.7.2"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/Users/charliele/.rbenv/versions/2.7.2/lib  -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  ...
  CONFIG["RANLIB"] = ":"
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple clang version 12.0.0 (clang-1200.0.32.28)\nTarget: x86_64-apple-darwin20.2.0\nThread model: posix\nInstalledDir: /Library/Developer/CommandLineTools/usr/bin"
  ...
  CONFIG["CXX"] = "clang++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/charliele/.rbenv/versions/2.7.2/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/charliele/.rbenv/versions/2.7.2/lib  -fstack-protector-strong -L/usr/local/lib"
  CONFIG["CFLAGS"] = "$(cflags)  -fno-common -pipe"
  CONFIG["CC"] = "clang"
  CONFIG["target_os"] = "darwin20"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "x86_64"
  CONFIG["target"] = "x86_64-apple-darwin20"
  CONFIG["host_os"] = "darwin20.2.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "x86_64"
  CONFIG["host"] = "x86_64-apple-darwin20.2.0"
  CONFIG["RUBY_VERSION_NAME"] = "$(RUBY_BASE_NAME)-$(ruby_version)"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "darwin20.2.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "x86_64"
  CONFIG["build"] = "x86_64-apple-darwin20.2.0"
